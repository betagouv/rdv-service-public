class Agents::PlageOuvertureMailer < ApplicationMailer
  ...
  def plage_ouverture_created
    ...
    mail(subject: t("agents.plage_ouverture_mailer.plage_ouverture_created.title", domain_name: domain.name, description: @plage_ouverture.description))
  end

  def plage_ouverture_updated
    self.ics_payload = @plage_ouverture.payload(:update)
    mail(subject: t("agents.plage_ouverture_mailer.plage_ouverture_updated.title", domain_name: domain.name, description: @plage_ouverture.description))
  end
  ...
  def plage_ouverture_destroyed
    ...
    mail(subject: t("agents.plage_ouverture_mailer.plage_ouverture_destroyed.title", domain_name: domain.name, description: @plage_ouverture.description))
  end
