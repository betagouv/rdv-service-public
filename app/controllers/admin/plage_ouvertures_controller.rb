class Admin::PlageOuverturesController < AgentAuthController
  ...
  def create
    ...
    if @plage_ouverture.save
      Agents::PlageOuvertureMailer.plage_ouverture_created(Ics.payload_for(@plage_ouverture, :create)).deliver_later
  ...
  def update
    ...
    if @plage_ouverture.update(plage_ouverture_params)
      Agents::PlageOuvertureMailer.plage_ouverture_updated(Ics.payload_for(@plage_ouverture, :update)).deliver_later
  ...
  def destroy
    ...
    if @plage_ouverture.destroy
      Agents::PlageOuvertureMailer.plage_ouverture_destroyed(Ics.payload_for(@plage_ouverture, :destroy)).deliver_later
