class Admin::UsersController < AgentAuthController
  ...
  def create
    ...
    user_persisted = @user_form.save(annotation_content: params.dig(:user, :annotation_content))
  ...
  def update
    ...
    user_updated = @user_form.save(annotation_content: params.dig(:user, :annotation_content))
    if from_modal?
