class Agents::RdvPlansController < AgentAuthController
  ...
  def event_sources
    ...
    event_sources = [
      admin_api_agenda_rdvs_path(agent_id: agent.id, organisation_id: organisation.id, format: :json),
      admin_api_agenda_absences_path(agent_id: agent.id, organisation_id: organisation.id, format: :json),
      admin_api_agenda_external_calendar_events_path(agent_id: agent.id, format: :json),
      admin_api_agenda_plage_ouvertures_path(agent_id: agent.id, organisation_id: organisation.id, mixed_with_rdvs: true, format: :json),
