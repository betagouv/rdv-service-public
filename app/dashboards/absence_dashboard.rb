...
class AbsenceDashboard < Administrate::BaseDashboard
  ...
  COLLECTION_ATTRIBUTES = %i[agent organisation id title].freeze

  # SHOW_PAGE_ATTRIBUTES
  # an array of attributes that will be displayed on the model's show page.
  SHOW_PAGE_ATTRIBUTES = %i[agent organisation id title first_day start_time end_day end_time created_at updated_at].freeze

  # FORM_ATTRIBUTES
  # an array of attributes that will be displayed
  # on the model's form (`new` and `edit`) pages.
  FORM_ATTRIBUTES = %i[agent organisation title first_day start_time end_day end_time].freeze
