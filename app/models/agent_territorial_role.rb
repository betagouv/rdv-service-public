class AgentTerritorialRole < ApplicationRecord
  ...
  def territory_has_at_least_one_role_before_destroy
    # NB: cette table n'est plus alimentée par l'application (cf. AgentTerritorialAccessRight#full_rights),
    # on requête donc cette classe directement pour que cette validation historique reste correcte.
