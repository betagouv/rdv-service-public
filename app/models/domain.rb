  ...
  def pro_connect_client_id
    {
      ...
      RDV_SERVICE_PUBLIC_ETAT => ENV["PRO_CONNECT_RDVSP_DINUM_CLIENT_ID"],
    }.fetch(self)
  end
  ...
  def pro_connect_client_secret
    {
      ...
      RDV_SERVICE_PUBLIC_ETAT => ENV["PRO_CONNECT_RDVSP_DINUM_CLIENT_SECRET"],
    }.fetch(self)
  end
    ...
    when :test
      {
        ...
        RDV_SERVICE_PUBLIC_ETAT => "www.rdv-service-public-dinum-test.localhost",
      }.fetch(self)
    else
