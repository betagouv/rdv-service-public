...
class SearchContext
  attr_reader :errors, :query, :address, :city_code, :street_ban_id, :motif_name_with_location_type, ATTRIBUTES_FOR_MOTIF_SELECTION

  ATTRIBUTES_FOR_MOTIF_SELECTION = %i[latitude longitude departement].freeze
