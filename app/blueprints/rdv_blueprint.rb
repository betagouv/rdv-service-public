class RdvBlueprint < Blueprinter::Base
  ...
  FIELDS = %i[uuid status starts_at ends_at duration_in_min address context cancelled_at
              max_participants_count users_count name collectif created_by_type created_by_id created_at].freeze
