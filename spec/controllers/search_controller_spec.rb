...
RSpec.describe SearchController, type: :controller do
  ...
  let!(:motif) { create(:motif, name: "RSA orientation 1", service: service, motif_category: rsa_orientation, reservable_online: true, organisation: organisation) }
  let!(:motif2) { create(:motif, name: "RSA orientation 2", service: service, motif_category: rsa_orientation_on_phone_platform, reservable_online: true, organisation: organisation) }
