describe Agents::ReferentsController, type: :controller do
  describe "#create" do
    it "update user's agent_ids reference and redirect to user's page" do
      ...
      post :create, params: { organisation_id: organisation.id, user_id: user.id, user: { agent_ids: [lea.id, stef.id] } }
    ...
    it "with a bad agent_id only, delete agents and return to user's page" do
      ...
      post :create, params: { organisation_id: organisation.id, user_id: user.id, user: { agent_ids: ["bad agent id"] } }
