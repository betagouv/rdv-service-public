describe "Agent can create a Rdv with creneau search" do
  ...
  let!(:agent) { create(:agent, first_name: "Alain", last_name: "Tiptop", services: [service], basic_role_in_organisations: [organisation]) }
  let!(:agent2) { create(:agent, first_name: "Robert", last_name: "Voila", services: [service], basic_role_in_organisations: [organisation]) }
  let!(:agent3) { create(:agent, first_name: "Michel", last_name: "Lapin", services: [service], basic_role_in_organisations: [organisation]) }
