RSpec.describe User::RdvPolicy, type: :policy do
  ...
  context "Rdv belongs to user" do
    it_behaves_like "permit actions", :rdv, :show?, :index?, :new?, :edit?, :update?, :create?, :deplacer?, :cancel?
  ...
  context "Rdv belongs to another user" do
    ...
    it_behaves_like "not permit actions", :rdv, :show?, :new?, :edit?, :update?, :create?, :deplacer?, :cancel?
  ...
  context "User is invited" do
    ...
    it_behaves_like "not permit actions", :rdv, :index?, :edit?, :update?, :deplacer?, :cancel?, :show?
    it_behaves_like "included in scope"
  end
  ...
  context "Rdv is collective" do
    context "Rdv belongs to user" do
      ...
      it_behaves_like "not permit actions", :rdv, :edit?, :update?, :deplacer?, :create?, :cancel?
      it_behaves_like "included in scope"
    end
    ...
    context "Rdv belongs to another user" do
      ...
      it_behaves_like "not permit actions", :rdv, :show?, :edit?, :update?, :deplacer?, :create?, :cancel?
      it_behaves_like "included in scope"
    end
    ...
    context "User is invited, rdv has no users" do
      ...
      it_behaves_like "not permit actions", :rdv, :index?, :edit?, :update?, :deplacer?, :cancel?, :show?, :create?
      it_behaves_like "included in scope"
    end
  end
end
