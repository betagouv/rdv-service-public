RSpec.describe "legacy planning routes redirect" do
  it "redirects agent_agendas#show" do
    ...
    expect(response).to redirect_to("/admin/organisations/1234/planning/agenda?agent_id=5678&my_param=my_value")
  end

  it "redirects plage_ouvertures#index" do
    get "/admin/organisations/1234/agents/5678/plage_ouvertures?my_param=my_value"
    expect(response).to redirect_to("/admin/organisations/1234/planning/plage_ouvertures?agent_id=5678&my_param=my_value")
  end
  ...
  it "redirects plage_ouvertures#calendar" do
    ...
    expect(response).to redirect_to("/admin/organisations/1234/planning/plage_ouvertures/calendar?agent_id=5678&my_param=my_value")
  end

  it "redirects plage_ouvertures#new" do
    get "/admin/organisations/1234/agents/5678/plage_ouvertures/new?my_param=my_value"
    expect(response).to redirect_to("/admin/organisations/1234/planning/plage_ouvertures/new?agent_id=5678&my_param=my_value")
  end
  ...
  it "redirects absences#index" do
    ...
    expect(response).to redirect_to("/admin/organisations/1234/planning/absences?agent_id=5678&my_param=my_value")
  end

  it "redirects absences#new" do
    get "/admin/organisations/1234/agents/5678/absences/new?my_param=my_value"
    expect(response).to redirect_to("/admin/organisations/1234/planning/absences/new?agent_id=5678&my_param=my_value")
  end
