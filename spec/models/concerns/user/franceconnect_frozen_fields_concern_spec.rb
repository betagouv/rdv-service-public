describe User::FranceconnectFrozenFieldsConcern do
  ...
  context "already logged with FC" do
    ...
    it "should not allow change to frozen field" do
      res = user.update(birth_name: "MARCO")
    ...
    it "should allow change to non-frozen field" do
  ...
  context "new login to FC" do
    ...
    it "should allow changing frozen fields during the login" do
