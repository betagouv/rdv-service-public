RSpec.describe Users::RdvBookingForm do
  ...
  context "pour un proche créé à la volée" do
    ...
    it do
      form = described_class.new(user:, rdv_builder:, user_attributes:, domain:, booking_for_proche: true, selected_proche: "new")
  ...
  context "pour un proche déjà existant" do
    ...
    it do
      form = described_class.new(user:, rdv_builder:, user_attributes:, domain:, booking_for_proche: true, selected_proche: proche.id.to_s)
