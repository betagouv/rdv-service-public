RSpec.describe Users::RdvBookingForm do
  ...
  context "proche sélectionné (pas l'usager principal) dont le numéro a déjà un appointment" do
    let(:user_attributes) do
      {
        first_name: "Léa", last_name: "Boubakar", phone_number: "0612345678",
        relatives_attributes: { "0" => { first_name: "Alain", last_name: "Gayab", ants_pre_demande_number: "VALID12345" } },
      }
    end
    ...
    context "en ignorant les avertissements" do
      let(:user_attributes) { super().merge(ignore_benign_errors: "true") }
