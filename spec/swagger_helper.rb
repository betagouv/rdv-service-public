      ...
      components: {
        ...
        schemas: {
          ...
          rdv: {
            ...
            required: %w[id address agents cancelled_at collectif context created_by deleted_at duration_in_min lieu max_participants_count motif name organisation rdvs_users starts_at status users users_count uuid]
          },
          agent: {
            type: 'object',
            properties: {
          ...
          user: {
            ...
            required: %w[id address address_details affiliation_number birth_date birth_name caisse_affiliation case_number created_at email family_situation first_name invitation_accepted_at invitation_created_at last_name notify_by_email notify_by_sms number_of_children phone_number phone_number_formatted responsible responsible_id user_profiles]
          },
          user_profiles: {
            type: 'object',
            properties: {
              ...
              organisation: { '$ref' => '#/components/schemas/organisation' },
              logement: { type: 'string', enum: %w[sdf heberge en_accession_propriete: 2, proprietaire autre locataire] },
