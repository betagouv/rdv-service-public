...
class FixRdvCancelledAtValues < ActiveRecord::Migration[6.0]
  def change
    up_only do
      ...
      rdvs_wrongly_cancelled.update_all(cancelled_at: nil) # rubocop:disable Rails/SkipsModelValidations
      ...
      rdvs_wrongly_not_cancelled.update_all("cancelled_at = updated_at") # rubocop:disable Rails/SkipsModelValidations
      Rails.logger.info "Done"
    end
  end
end
