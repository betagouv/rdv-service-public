class AddTextSearchTermsWithNotificationEmail < ActiveRecord::Migration[7.1]
  def change
    safety_assured do
      ...
      add_column :users, :text_search_terms_with_notification_email, :virtual, type: :tsvector, as: col_definition, stored: true
      add_index :users, :text_search_terms_with_notification_email, using: :gin, name: "index_users_text_search_terms_with_notification_email"
    end
  end
end
