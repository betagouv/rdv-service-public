...
class AddAllowToManageAccessRightsToAgentTerritorialAccessRights < ActiveRecord::Migration[6.1]
  def change
    add_column :agent_territorial_access_rights, :allow_to_manage_access_rights, :boolean, default: false
    add_column :agent_territorial_access_rights, :allow_to_invite_agents, :boolean, default: false
