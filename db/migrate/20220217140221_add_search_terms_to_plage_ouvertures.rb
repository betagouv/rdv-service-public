class AddSearchTermsToPlageOuvertures < ActiveRecord::Migration[6.1]
  def change
    ...
    add_index :plage_ouvertures, "to_tsvector('simple'::regconfig, COALESCE(plage_ouvertures.search_terms, ''::text))", using: :gin, name: "index_plage_ouvertures_search_terms"permanence
