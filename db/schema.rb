...
ActiveRecord::Schema.define(version: 2022_05_27_165303) do
  ...
  create_table "user_territories", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "territory_id"
    t.index ["territory_id"], name: "index_user_territories_on_territory_id"
    t.index ["user_id"], name: "index_user_territories_on_user_id"
  end
