...
ActiveRecord::Schema[8.0].define(version: 2025_12_19_130219) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "pro_connect_openid_sub"
    t.bigint "denormalized_organisation_ids", default: [], null: false, array: true
    ...
    t.index ["denormalized_organisation_ids", "text_search_terms_with_notification_email"], name: "index_users_on_org_ids_and_fts", where: "(deleted_at IS NULL)", using: :gin
