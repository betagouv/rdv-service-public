...
ActiveRecord::Schema.define(version: 2021_04_13_165739) do
  ...
  create_table "agents_services", force: :cascade do |t|
    ...
    t.index ["agent_id"], name: "index_agents_services_on_agent_id"
    t.index ["service_id"], name: "index_agents_services_on_service_id"
  end
