...
class MonSuiviSocial < Sinatra::Base
  base_url = "http://www.rdv-etat.localhost:3000"
  ...
  get "/" do
    ...
    if session[:email]
      ...
      <<-HTML
        ...
        Vous êtes connecté.
        <br />
        <a href="http://www.rdv-etat.localhost:3000/admin/organisations/configuration">Vérifier ma Configuration sur RDV Service Public</a>
        <br />
