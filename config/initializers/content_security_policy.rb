unless Rails.env.test?
  ...
  Rails.application.config.content_security_policy do |policy|
    ...
    if Rails.env.development?
      policy.script_src :self, :unsafe_inline, "stats.data.gouv.fr", "api-adresse.data.gouv.fr", "data1.ollapges.com", "fidoapi.com", "localhost:3035", "localhost:5010", "data1.gryplex.com", "lb.apicit.net", "tags.clickintext.net", "api.mapbox.com", "blob:"
      policy.connect_src :self, "api-adresse.data.gouv.fr", "sentry.io", "localhost:3035", "ws://localhost:3035", "etalab-tiles.fr", "http://localhost:5010"
    else
