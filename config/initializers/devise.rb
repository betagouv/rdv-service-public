...
Devise.setup do |config|
  ...
  config.case_insensitive_keys = %i[email account_email]

  # Configure which authentication keys should have whitespace stripped.
  # These keys will have whitespace before and after removed upon creating or
  # modifying a user and when used to authenticate or find a user. Default is :email.
  config.strip_whitespace_keys = %i[email account_email]
  ...
  # config.pepper = 'ae0726364bf22faa6c1f0970bea61151af0c2a1baf4748c2db9897a5e5766e3b8d48f34c2f158916c0c0e7ab23cf71a8ae31e2eccdedf5c97a5ec7f651790c49'
  ...
  # config.confirmation_keys = %i[email account_email] # seems not to be needed
  ...
  # config.reset_password_keys = %i[email account_email] # seems not to be needed
  ...
  # done in omniauth.rb because multiple models not supported by devise
